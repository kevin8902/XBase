...
public class XBaseRefreshLayout extends ViewGroup {
    ...
    public XBaseRefreshLayout(Context context) {
        this(context, null);
    }

    public XBaseRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    public void autoRefresh() {
        isRefreshOrLoading = true;
        animateToPositionForRefresh(defaultBeforeDistance);
        if (refreshViewListener != null) {
            refreshViewListener.onRefresh(refreshView);
        }
        if (onStartListener != null) {
    ...
    public interface OnStartListener {
         ...
         * @param v
         */
        public void onStartRefresh(XBaseRefreshLayout v);
         ...
         * @param v
         */
        public void onStartLoadmore(XBaseRefreshLayout v);
    }
